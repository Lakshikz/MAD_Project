...
import static com.example.mad_project.Constants.MAX_BYTES_PDF;
...
import com.example.mad_project.adapters.AdapterPdfAdmin;
...
public class MyApplication extends Application {
    ...
    public static void deleteBook(Context context ,String bookId , String bookUrl ,String bookTitle) {
        ...
        progressDialog.setTitle("Deleting "+bookTitle+" ....");
        progressDialog.show();
    ...
    public static void downloadBook(Context context , String bookId , String bookTitle , String bookUrl){
        ...
        Dialog progressDialog = new Dialog(context);
        progressDialog.setTitle("Please wait");
        progressDialog.setTitle("Downloading"+nameWithExtension+"...");
    ...
    private static void saveDownloadedBook(Context context, Dialog progressDialog, byte[] bytes, String nameWithExtension, String bookId) {
        ...
        ref.child(bookId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //convert to long ande increment 1
