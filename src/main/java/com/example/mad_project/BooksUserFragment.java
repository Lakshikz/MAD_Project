...
import com.example.mad_project.adapters.AdapterPdfUser;
import com.example.mad_project.databinding.FragmentBooksUserBinding;
...
public class BooksUserFragment extends Fragment {
    ...
    private void loadCategorizesBooks() {
