...
import com.example.mad_project.databinding.ActivityPdfAddBinding;
        ...
        ref.child(""+timestamp)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(PdfAddActivity.this, "Failed to upload db due to"+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
